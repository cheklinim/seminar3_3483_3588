...
После внесения изменений в код форка и их загрузки на GitHub появляется возможность предложить их на рассмотрение владельцу оригинального репозитория. Для этого необходимо нажать кнопку **Compare and pull request**, либо открыть меню **Contribute** и нажать в нем кнопку **Open pull request**. При отправке имеется возможность оставить сообщение для владельца репозитория. Непосредственно отправка осуществляется после нажатия кнопки **Create pull request**.