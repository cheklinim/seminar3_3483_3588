...
Сайт GitHub спроектирован под определенную схему работы, сконцентрированную вокруг запросов на включение. Эта схема организована по принципу тематических веток(branch).
