...
Для загрузки данных в удаленный репозитарию сначала нужно к нему подключиться.Для этого используется команда:

    git remote

### Отправление изменений в удаленный репозиторий

Отправка коммитов в удаленный репозиторий осуществляется с помощью команды:
...
Если другим пользователям нет необходимости делать клон удаленного репозитария, а нужно просто получить информацию об изменениях, это можно сделать с помощью команды:
