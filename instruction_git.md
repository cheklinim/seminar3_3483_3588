...
Чтобы работать в команде или делиться с другими файлами или кодом, используются удаленные репозитории. Например, GitHub. 
...
На удаленном репозитории есть в открытом доступе программы, в которые могут вносить изменения любые пользователи. Но для этого необходимо выполнить следующие шаги:
