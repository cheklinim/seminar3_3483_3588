...
Команда позволяет получить из интернета (GitHub) актуальное состояние репозитория и скачать его на локальный репозиторий. Это составная команда, она также мержит (сливает) изенения с нашими. Рекомендуется проделоть команду до того, как пушить изменения.
