...
Затем проверить историю знакомыми нам командами git status и git log, и можно продолжать свою работу в скопированных документах. 

Чтобы показать свои новые изменения всем, кто с нами работает над этим же проектом, направляем их в Github командой:
