...
## Список удаленных подключений

Для того,  чтобы получить список удаленных подключений к репозиторию, служит команда remote:
    $ git remote 

## Отправлять локальную ветку на удаленный репозиторий

Для того, чтобы отправить локальную ветку на удаленный репозиторий, служит команда push:

$ git push

## Обновить локальную ветку с сервера

Для того, чтобы обновить локальную ветку с сервера, служит команда pull:
